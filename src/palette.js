...
export const DARK_PAINTS = new Set(["blue", "black", "magenta"]);

export const PALETTE = [
  {
    id: 1, hex: "040B1A", rgb: [4, 11, 26],
    hsb: [221, 85, 10], cmyk: [84, 57, 0, 89],
    recipe: [{ paint: "blue", parts: 1 }, { paint: "black", parts: 4 }],
  },
  {
    id: 2, hex: "BD2940", rgb: [189, 41, 64],
    hsb: [351, 78, 74], cmyk: [0, 78, 66, 25],
    recipe: [{ paint: "white", parts: 2 }, { paint: "red", parts: 5 }, { paint: "blue", parts: 1 }],
  },
  {
    id: 3, hex: "3A1727", rgb: [58, 23, 39],
    hsb: [333, 60, 23], cmyk: [0, 60, 32, 77],
    recipe: [{ paint: "yellow", parts: 1 }, { paint: "red", parts: 5 }, { paint: "blue", parts: 3 }, { paint: "black", parts: 4 }],
  },
  {
    id: 4, hex: "0F3963", rgb: [15, 57, 99],
    hsb: [210, 85, 39], cmyk: [84, 42, 0, 61],
    recipe: [{ paint: "yellow", parts: 2 }, { paint: "red", parts: 1 }, { paint: "blue", parts: 6 }, { paint: "black", parts: 2 }],
  },
  {
    id: 5, hex: "121B31", rgb: [18, 27, 49],
    hsb: [223, 63, 19], cmyk: [63, 44, 0, 80],
    recipe: [{ paint: "white", parts: 2 }, { paint: "red", parts: 1 }, { paint: "black", parts: 9 }, { paint: "blue", parts: 4 }],
  },
  {
    id: 7, hex: "661124", rgb: [102, 17, 36],
    hsb: [347, 83, 40], cmyk: [0, 83, 64, 60],
    recipe: [{ paint: "yellow", parts: 2 }, { paint: "red", parts: 1 }, { paint: "magenta", parts: 2 }, { paint: "black", parts: 3 }],
  },
  {
  ...
  },
  {
    ...
    recipe: [{ paint: "white", parts: 1 }, { paint: "green", parts: 3 }, { paint: "magenta", parts: 2 }, { paint: "blue", parts: 3 }],
  },
];
